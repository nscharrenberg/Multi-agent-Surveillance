...
public class ShadowTileTest {
    ...
    void shadowUpBoundsLevel1(){
        ...
        int xBound = 10;
        int yBound = 10;
        Assertions.assertTrue(checkShadowTile(tile, xBound, yBound, Angle.UP));
    }
    ...
    void shadowUpBoundsLevel3(){
        ...
        int xBound = 10;
        int yBound = 10;
        Assertions.assertFalse(checkShadowTile(tile, xBound, yBound, Angle.UP));
    }
    ...
    void shadowDownBoundsLevel1(){
        ...
        int xBound = 10;
        int yBound = 10;
        Assertions.assertTrue(checkShadowTile(tile, xBound, yBound, Angle.DOWN));
    }
    ...
    void shadowDownBoundsLevel3(){
        ...
        int xBound = 10;
        int yBound = 10;
        Assertions.assertFalse(checkShadowTile(tile, xBound, yBound, Angle.DOWN));
    }
    ...
    void shadowLeftBoundsLevel1(){
        ...
        int xBound = 10;
        int yBound = 10;
        Assertions.assertTrue(checkShadowTile(tile, xBound, yBound, Angle.LEFT));
    }
    ...
    void shadowLeftBoundsLevel3(){
        ...
        int xBound = 10;
        int yBound = 10;
        Assertions.assertFalse(checkShadowTile(tile, xBound, yBound, Angle.LEFT));
    }
    ...
    void shadowRightBoundsLevel1(){
        ...
        int xBound = 10;
        int yBound = 10;
        Assertions.assertTrue(checkShadowTile(tile, xBound, yBound, Angle.RIGHT));
    }
    ...
    void shadowRightBoundsLevel3(){
        ...
        int xBound = 10;
        int yBound = 10;
        Assertions.assertFalse(checkShadowTile(tile, xBound, yBound, Angle.RIGHT));
    }




    private boolean checkShadowTile(Tile tile, int xBound, int yBound, Angle direction){
